...
parser.add_argument('--wandb-project', type=str, default='pan-Arctic-SR', help='Wandb project name')

# data
parser.add_argument('--lenght', type=int, default=400, type=int, help='Sampler lenght')
parser.add_argument('--size', type=int, default=240, type=int, help='Patch size')
